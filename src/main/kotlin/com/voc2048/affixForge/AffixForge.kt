...
import com.voc2048.affixForge.listener.AffixGameplayListener
...
class AffixForge : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        server.pluginManager.registerEvents(AffixGameplayListener(this), this)

        logger.info("AffixForge has been enabled with flattened affix system!")
    }
